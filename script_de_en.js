...
function loadQuestion() {
    ...
    // Deutsche Frage anzeigen
    document.getElementById("question").innerText = `Was ist die englische Übersetzung für: '${word.deutsch}'?`;
    document.getElementById("options").innerHTML = "";
    correctAnswer = word.englisch;
